 ...
 *  my.bundle.greeting = Hello, ${my.bundle.user.name}!\
 *                       I see you're from ${my.bundle.user.state}.
 */
public class ResourceBundleUtil {
	...
	private static final class SelfReferencingResourceBundle extends ResourceBundle {
		...
		@Override
		public Enumeration<String> getKeys() { return keys; }

		@Override
		protected Object handleGetObject(String key) { return messages.get(key); }
	}
